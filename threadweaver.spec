...
Source0  : https://download.kde.org/stable/frameworks/5.113/threadweaver-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/threadweaver-5.113.0.tar.xz.sig
...
%prep
%setup -q -n threadweaver-5.113.0
cd %{_builddir}/threadweaver-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702987180
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5ThreadWeaver.so.5.113.0
/usr/lib64/libKF5ThreadWeaver.so.5
/usr/lib64/libKF5ThreadWeaver.so.5.113.0
