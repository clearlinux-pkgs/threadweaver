...
Source0  : https://download.kde.org/stable/frameworks/6.7/threadweaver-6.7.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.7/threadweaver-6.7.0.tar.xz.sig
...
%setup -q -n threadweaver-6.7.0
cd %{_builddir}/threadweaver-6.7.0
pushd ..
cp -a threadweaver-6.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728754375
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6ThreadWeaver.so.6.7.0
/usr/lib64/libKF6ThreadWeaver.so.6
/usr/lib64/libKF6ThreadWeaver.so.6.7.0
