...
Source0  : https://download.kde.org/stable/frameworks/5.91/threadweaver-5.91.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.91/threadweaver-5.91.0.tar.xz.sig
...
%prep
%setup -q -n threadweaver-5.91.0
cd %{_builddir}/threadweaver-5.91.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644799762
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/threadweaver-5.91.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/threadweaver/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/threadweaver-5.91.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/threadweaver/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/threadweaver-5.91.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/threadweaver/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5ThreadWeaver.so.5.91.0
